...
# Load the CSV files
df_tree = pd.read_csv('gowalla_tree_extra_level_dist_table_s3600_q133500.csv')
df_3dag = pd.read_csv('gowalla_dag3_extra_level_dist_table_s3600_q133500.csv')
df_5dag = pd.read_csv('gowalla_dag5_extra_level_dist_table_s3600_q133500.csv')
